...
$menue_array = array(
  ...
  "misc" => array(
      ...
      "50" => array("name"=>"Statistics","image"=>"images/iconstatistics.gif",
                    "link"=>"list.php?view=statistic_memory",
                    "class"=>"menuparent",
                    "childs"=>array("10"=>array("name"=>"OS Type", "link"=>"./list.php?view=statistic_os", "image"=>"images/os.png", "title"=>"OS Type",),
                                    ...
                                    "27"=>array("name"=>"Java Versions", "link"=>"./list.php?view=statistic_java", "image"=>"images/java.png", "title"=>"Java Versions",),
                                    "28"=>array("name"=>"GoogleChrome Versions", "link"=>"./list.php?view=statistic_chrome", "image"=>"images/browser_gc.png", "title"=>"Google Chrome Versions",),
      ...
      "60" => array("name"=>"Admin", "image"=>"images/iconsettings.gif",
                    ...
                    "class"=>"menuparent",
                    "childs"=>array("10"=>array("name"=>"Delete/Create new database", "link"=>"./setup.php", "image"=>"images/notes.png", "title"=>"",),
                    				"11"=>array("name"=>"Config", "link"=>"admin_config.php?sub=1", "image"=>"images/settings.png", "title"=>"",),
                    				"12"=>array("name"=>"Select Database", "link"=>"changedatabase.php", "image"=>"images/settings.png", "title"=>"Select what database of installed dbs to use",),
...
//                                    "100"=>array("name"=>"", "link"=>"","image"=>"","title"=>"",),  
      ...
      "70" => array("name"=>"Help", "image"=>"images/iconinfo.gif",
                    ...
                    "childs"=>array("60"=>array("name"=>"Help Tips&Tricks", "link"=>"./show_tips.php", "image"=>"images/notes.png", "title"=>"Tipps und Tricks anzeigen",),
                                    "50"=>array("name"=>"GPL Lizense Display", "link"=>"./show_license.php", "image"=>"images/notes.png", "title"=>"Using the Open-Audit database from OpenOffice to create more complex reports.",),
                             ),       
              ),
  ),
);
