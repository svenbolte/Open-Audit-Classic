  ...
  "misc" => array(
      ...
      "60" => array("name"=>"Admin", "image"=>"images/iconsettings.gif",
                    ...
                    "childs"=>array(
                    				...
                    				"11"=>array("name"=>"Import SVVersionen", "link"=>"import_svversion.php", "image"=>"images/database.gif", "title"=>"Softwareversions and license Database import",),
									"13"=>array("name"=>"Delete/Create new database", "link"=>"./setup.php", "image"=>"images/notes.png", "title"=>"",),
                    				"15"=>array("name"=>"Config", "link"=>"admin_config.php?sub=1", "image"=>"images/settings.png", "title"=>"",),
