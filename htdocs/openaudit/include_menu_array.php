  ...
  "misc" => array(
	  ...
	  "20" => array("name"=>"Other Items","image"=>"fa-print",
                    ...
                    "childs"=>array("10"=>array("name"=>"Printers", "link"=>"./list.php?view=all_printers", "image"=>"images/printer.png", "title"=>"List all Printer",),
                                    "15"=>array("name"=>"Printers IPv4", "link"=>"./list.php?view=all_printers_ipv4", "image"=>"images/printer-network.png", "title"=>"List all IPv4 Printers",),
      ...
      "28" => array("name"=>"Statistics","image"=>"fa-bar-chart",
                    ...
                    "childs"=>array(
                                    ...
                                    "15"=>array("name"=>"Java Versions", "link"=>"./list.php?view=statistic_java", "image"=>"images/java.png", "title"=>"Java Versions",),
                                    "20"=>array("name"=>"Adobe Flash Player Versions", "link"=>"./list.php?view=statistic_adobe_flash_player", "image"=>"images/adobe_flash_player.png", "title"=>"Adobe Flash Player Versions",),
                                    "25"=>array("name"=>"Adobe Reader Versions", "link"=>"./list.php?view=statistic_adobe_reader", "image"=>"images/adobe_reader.png", "title"=>"Adobe Reader Versions",),
                                    "30"=>array("name"=>"GoogleChrome Versions", "link"=>"./list.php?view=statistic_chrome", "image"=>"images/browser_gc.png", "title"=>"Google Chrome Versions",),
                                    "35"=>array("name"=>"Edge on Chromium Versions", "link"=>"./list.php?view=statistic_edgenew", "image"=>"images/browser-newedge.png", "title"=>"Edge on Chromium Versions",),
                                    "40"=>array("name"=>"IE Versions", "link"=>"./list.php?view=statistic_ie", "image"=>"images/browser.png", "title"=>"Internet Explorer Versions",),
                                    "45"=>array("name"=>"Firefox Versions", "link"=>"./list.php?view=statistic_firefox", "image"=>"images/browser_ff.png", "title"=>"Mozilla Firefox Versions",),
                                    "50"=>array("name"=>"Msoffice Versions", "link"=>"./list.php?view=statistic_microsoftoffice", "image"=>"softwarelogos/microsoft.png", "title"=>"Microsoft Office Versions",),
                                    "60"=>array("name"=>"Libreoffice Versions", "link"=>"./list.php?view=statistic_openoffice.org", "image"=>"softwarelogos/libreoffice.png", "title"=>"Libreoffice Versions",),
                                    "65"=>array("name"=>"Thunderbird Versions", "link"=>"./list.php?view=statistic_thunderbird", "image"=>"images/mail_tb.png", "title"=>"Mozilla Thunderbird Versions",),
									"67"=>array("name"=>"OS Type", "link"=>"./list.php?view=statistic_os", "image"=>"images/os.png", "title"=>"OS Type",),
                                    "70"=>array("name"=>"Printer Models", "link"=>"list.php?view=statistic_printer", "image"=>"images/printer.png", "title"=>"Printer Models",), 
                                    "75"=>array("name"=>"Memory Size", "link"=>"./list.php?view=statistic_memory", "image"=>"images/memory.png", "title"=>"Memory Size",),
                                    "80"=>array("name"=>"Processor Types", "link"=>"./list.php?view=statistic_processor", "image"=>"images/processor.png", "title"=>"Processor Types",),
                                    "85"=>array("name"=>"Hard Drive", "link"=>"./list.php?view=statistic_harddrive", "image"=>"images/harddisk.png", "title"=>"Hard Drive",),
                                    "90"=>array("name"=>"Keys", "link"=>"./list.php?view=statistic_keys", "image"=>"images/key_2.png", "title"=>"Keys",),
                                    "92"=>array("name"=>"Model", "link"=>"list.php?view=statistic_model", "image"=>"images/computer.png", "title"=>"Modelle",), 
                                    "94"=>array("name"=>"Manufacturer", "link"=>"list.php?view=statistic_manufacturer", "image"=>"images/computer.png", "title"=>"Hersteller",), 
                              ),
              ),
      ...
      "60" => array("name"=>"Admin", "image"=>"fa-cog",
                    ...
                    "class"=>"menuparent",
                    "childs"=>array(
                    				"8"=>array("name"=>"IP-Liste erzeugen", "link"=>"export-ipliste-4-openaudit.php", "image"=>"images/ipliste.png", "title"=>"pc_list_file_text aus Netzwerkliste erstellen",),
									"10"=>array("name"=>"Import SVVersionen", "link"=>"import_svversion.php", "image"=>"images/iconnumber.gif", "title"=>"Softwareversions and license Database import",),
