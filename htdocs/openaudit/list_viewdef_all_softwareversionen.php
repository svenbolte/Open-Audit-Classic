...
$query_array=array("headline"=>__("List all Software-Versions"),
                   "sql"=>"SELECT sv_datum,sv_rating,sv_id,sv_product,sv_version,sv_bemerkungen,sv_vorinstall,sv_quelle,sv_lizenztyp,sv_lizenzgeber,sv_lizenzbestimmungen,sv_herstellerwebsite FROM softwareversionen",
                   "sort"=>"sv_product",
                   "dir"=>"ASC",
