...
$query_array=array("headline"=>__("List all Laptops"),
                   "sql"=>"SELECT * FROM `system`, `processor`, `hard_drive` WHERE system_uuid = hard_drive_uuid
					AND (system_system_type = 'Laptop' OR system_system_type = 'Expansion Chassis' OR system_system_type = 'Convertible' OR system_system_type = 'Tablet' OR system_system_type = 'Detachable' OR system_system_type = 'Notebook' or system_system_type = 'Sub Notebook' OR system_system_type = 'Portable' OR system_system_type = 'Docking Station' OR system_system_type = 'Peripheral Chassis') 
                   ...
                   "fields"=>array("10"=>array("name"=>"system_uuid",
                                  ...
                                  "34"=>array("name"=>"system_version",
                                   ...
                                   "50"=>array("name"=>"system_vcpu",
                                               "head"=>__("v cpu"),
                                               "show"=>"y",
                                              ),
                                   "51"=>array("name"=>"system_vendor",
                                               "head"=>__("Vendor"),
                                               "show"=>"y",
                                              ), 
