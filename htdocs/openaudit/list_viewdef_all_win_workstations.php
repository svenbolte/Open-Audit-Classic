...
$query_array=array("headline"=>__("List all Windows Workstations"),
                   "sql"=>"SELECT * FROM `system`, `processor`, `hard_drive` WHERE system_uuid = hard_drive_uuid
					AND (system_system_type = 'Other' OR system_system_type = 'Unknown' OR system_system_type = 'Desktop' OR system_system_type = 'Low Profile Desktop'
						OR system_system_type = 'Pizza Box' OR system_system_type = 'Mini Tower' OR system_system_type = 'Tower'
						OR system_system_type = 'All in One' OR system_system_type = 'Space-Saving' OR system_system_type = 'Lunch Box' OR system_system_type = 'Sealed-Case PC' 
						OR system_system_type = 'Embedded PC' OR system_system_type = 'Mini PC' OR system_system_type = 'Stick PC' )
