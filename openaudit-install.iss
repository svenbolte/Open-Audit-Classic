; Script generated by the Inno Setup Script 6.2.1 Wizard.
...
#define Inhalte "Apache 2.4.53x64-VC16, MySQLMariaDB 10.4.25x64, PHP 8.0.19x64-thrsafe, phpMyAdmin 5.2.0x64, NMap 7.92, NPCap 1.60, Wordpress 5.9.3, WPKG 1.31*, VCRuntimes Mai2022"
...
[Run]
Filename: "{sys}\schtasks.exe"; Parameters: "/create /XML ""{app}\htdocs\openaudit\all-tools-scripts\jobsundbatches\Open-Audit PC Inventar taeglich.xml"" /TN Openaudit-PCScan"; Flags: postinstall runasoriginaluser; Description: "PC Scan Aufgabe importieren"; Tasks: Aufgabepcscan
Filename: "{sys}\schtasks.exe"; Parameters: "/create /XML ""{app}\htdocs\openaudit\all-tools-scripts\jobsundbatches\Open-Audit NMAP Inventar taeglich.xml"" /TN Openaudit-NMAPScan"; Flags: postinstall runasoriginaluser; Description: "NMAP Scan Aufgabe importieren"; Tasks: AufgabeNMAPScan
