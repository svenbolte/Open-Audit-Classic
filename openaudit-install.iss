...
#define Inhalte "Apache 2.4.56x64-VS17, MySQLMariaDB 10.6.12x64, PHP 8.2.4x64-thsafe, phpMyAdmin 5.2.1x64, NMap 7.93, NPCap 1.72(extern), Wordpress 6.1.1, VC17Runtimes aktuell"
...
Filename: "{app}\nmap\npcap-1.72.exe"; Flags: shellexec postinstall runascurrentuser; Description: "für NMAP benötigtes NPCap installieren"
